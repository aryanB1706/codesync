  ...
  useEffect(() => {
    const initSocket = async () => {
      ...
      socketRef.current.on("file_created", ({ fileName, language, value }) => {
        setFiles((prev) => {
          // Agar file pehle se nahi hai, tabhi add karo
          if (!prev[fileName]) {
            return {
              ...prev,
    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          ...
          ></div>
          <span
            style={{ fontWeight: "600", color: "#ccc", letterSpacing: "1px" }}
          >
            CodeSync Pro
          </span>
        </div>
            ...
            {Object.keys(files).map((fileName) => (
              <div
                ...
                style={{
                  ...
                  cursor: "pointer",
                  background:
                    activeFileName === fileName ? "#37373d" : "transparent",
